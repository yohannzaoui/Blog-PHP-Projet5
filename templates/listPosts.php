  ...
  <div class="row">
    ...
    <?php foreach ($posts as $post) :?>
      <div class="post-preview">
          <h4 class="post-title"><?= htmlspecialchars($post->getTitle()) ?></h4>
          <h5 class="post-subtitle"><?= htmlspecialchars($post->getSubtitle())?></h5>
        <p class="post-meta">
        ...
        <a class="btn btn-danger" href="index.php?route=deletePost&id=<?=$post->getId()?>">Supprimer article et commentaires</a></p>
      </div>
      <hr>
      <?php endforeach; ?>
    </div>
